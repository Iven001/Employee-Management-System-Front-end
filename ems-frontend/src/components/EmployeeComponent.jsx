...
const EmployeeComponent = () => {
  ...
  const [errors, setErrots] = useState({
    firstName:'',
    lastName:'',
    mail:'',
    department : ''
  ...
  const saveOrUpdateEmployee = (e) =>{
    ...
    if(validateForm()) {
      ...
      const employee = {firstName, lastName, mail,departmentId}
  ...
  function validateForm(){
        ...
        if(mail.trim()){
            ...
            errorsCopy.mail = 'Mail is required';
            valid = false;
        }
        ...
        if(departmentId){
          ...
          errorsCopy.department = 'Select department is required';
          valid = false;
      }

        setErrots(errorsCopy);
